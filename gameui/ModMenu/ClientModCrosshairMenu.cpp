...
CrosshairImagePanelMod::CrosshairImagePanelMod( Panel *parent, const char *name, ClientModCrosshairMenu* pOptionsPanel ) : ImagePanel( parent, name )
{
	...
	m_pCrosshairAlpha = new CCvarSlider( m_pOptionsPanel, "CrosshairAlpha", "Alpha", 0.0f, 255.0f, "xhair_color_a" );
	m_pCrosshairUseAlpha = new CCvarToggleCheckButton( m_pOptionsPanel, "CrosshairUseAlpha", "Use translucency", "xhair_usealpha" );
	m_pCrosshairGap = new CCvarSlider( m_pOptionsPanel, "CrosshairGap", "Gap", -5.0f, 5.0f, "xhair_gap" );
	m_pCrosshairGapUseWeaponValue = new CCvarToggleCheckButton( m_pOptionsPanel, "CrosshairGapUseWeaponValue", "Use weapon accuracy for gap", "xhair_gap_useweapon" );
	m_pCrosshairSize = new CCvarSlider( m_pOptionsPanel, "CrosshairSize", "Size", 0.0f, 10.0f, "xhair_size" );
	m_pCrosshairThickness = new CCvarSlider( m_pOptionsPanel, "CrosshairThickness", "Thickness", 0.1f, 6.0f, "xhair_thickness" );
	m_pCrosshairDot = new CCvarToggleCheckButton( m_pOptionsPanel, "CrosshairDot", "Center Dot", "xhair_dot" );
	m_pCrosshairColorR = new CCvarSlider( m_pOptionsPanel, "CrosshairColorR", "R", 0.0f, 255.0f, "xhair_color_r" );
	m_pCrosshairColorG = new CCvarSlider( m_pOptionsPanel, "CrosshairColorG", "G", 0.0f, 255.0f, "xhair_color_g" );
	m_pCrosshairColorB = new CCvarSlider( m_pOptionsPanel, "CrosshairColorB", "B", 0.0f, 255.0f, "xhair_color_b" );
	m_pCrosshairDrawOutline = new CCvarToggleCheckButton( m_pOptionsPanel, "CrosshairDrawOutline", "Draw outline", "xhair_outline" );
	m_pCrosshairOutlineThickness = new CCvarSlider( m_pOptionsPanel, "CrosshairOutlineThickness", "", 0.0f, 3.0f, "xhair_outline_adjust" );
	m_pCrosshairT = new CCvarToggleCheckButton( m_pOptionsPanel, "CrosshairT", "T Style", "xhair_t_style" );
	m_pCrosshairColor = new CLabeledCommandComboBox( m_pOptionsPanel, "CrosshairColor" );

	m_pCrosshairStyle->AddItem( "Classic Static", "xhair_style 0" );
	m_pCrosshairStyle->AddItem( "Classic Dynamic", "xhair_style 1" );
	m_pCrosshairStyle->AddItem( "Default", "xhair_style 2" );
	m_pCrosshairStyle->AddItem( "Default Static", "xhair_style 3" );
	m_pCrosshairStyle->AddItem( "Style 5", "xhair_style 4" );
