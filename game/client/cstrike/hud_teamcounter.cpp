...
void CHudTeamCounter::OnThink()
{
        ...
        /* 
        // CS:S does not support WarmupPeriod
        ...
        */
        ...
        {
                /* 
                // CS:S does not support TimeOuts
                ...
                */
                {
                        ...
                        // Adapted for CS:S: StartTime is when freeze started, so add freeze time length
                        m_iRoundTime = (int) ceil( (pRules->GetRoundStartTime() + mp_freezetime_ref.GetFloat()) - gpGlobals->curtime );
                }
        }
