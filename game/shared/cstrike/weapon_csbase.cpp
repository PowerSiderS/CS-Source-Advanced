...
static ConVar xhair_dot( "xhair_dot", "0", FCVAR_ARCHIVE );
static ConVar xhair_color_r( "xhair_color_r", "50", FCVAR_ARCHIVE );
static ConVar xhair_color_g( "xhair_color_g", "250", FCVAR_ARCHIVE );
